...
const IBLPMic = (() => {
const ENDPOINT_ST = '/iblp/recognize.php';   // Sesotho model
const ENDPOINT_EN = '/iblp/recognize_english.php?topic=numbers'; // Whisper
  const SAMPLE_RATE  = 22050;
  const RECORD_MS    = 1500;             // record for 1.5s then auto-stop
